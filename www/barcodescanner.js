 ...
 * @param config
 */
BarcodeScanner.prototype.scan = function (...args) {
  return new Promise((resolve, reject) => {
    let [successCallback, errorCallback, config] = args.length == 3
      ? args
      : [resolve, reject, args[0]];
...
//-------------------------------------------------------------------
BarcodeScanner.prototype.encode = function (type, data, ...args) {
  return new Promise((resolve, reject) => {
    let [successCallback, errorCallback, options] = args.length === 3
      ? args
      : [resolve, reject, args[0]];
